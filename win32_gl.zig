...
pub const PFNWGLALLOCATEMEMORYNVPROC = ?fn (GLsizei, GLfloat, GLfloat, GLfloat) callconv(WINAPI) ?*c_void;
...
pub const PFNWGLDXOPENDEVICENVPROC = ?fn (?*c_void) callconv(WINAPI) HANDLE;
pub const PFNWGLDXREGISTEROBJECTNVPROC = ?fn (HANDLE, ?*c_void, GLuint, GLenum, GLenum) callconv(WINAPI) HANDLE;
pub const PFNWGLDXSETRESOURCESHAREHANDLENVPROC = ?fn (?*c_void, HANDLE) callconv(WINAPI) BOOL;
...
pub const PFNWGLFREEMEMORYNVPROC = ?fn (?*c_void) callconv(WINAPI) void;
...
pub const PFNWGLGETGPUINFOAMDPROC = ?fn (UINT, c_int, GLenum, UINT, ?*c_void) callconv(WINAPI) INT;
